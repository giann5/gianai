...
- Generación CSV nativa (sin dependencia adicional)
...
- `WA_ROOT`: raíz portable (si existe, por defecto se usa `WA_ROOT/app/output`).
- `WA_OUTPUT_DIR`: sobreescribe la salida explícitamente.
- `WA_PROFILE_DIR`: perfil Playwright persistente.
- `PLAYWRIGHT_BROWSERS_PATH`: ruta de navegadores Playwright portable.
